    ...
    class MenuListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (btn == menuPanel.getBtnArea()) {
                ...
                Chart chartParent = new Chart();
                final CategoryDataset dataset;
                try {
                    dataset = chartParent.createDataset();
                    final JFreeChart chart = chartParent.createChart(dataset);
                    final org.jfree.chart.ChartPanel chartPnl = new org.jfree.chart.ChartPanel(chart);
                    serverFrame.getMainSplitPane().setRightComponent(chartPnl); 
                } catch (SQLException ex) {
...
//        final String category = "Category 5";
...
//        dataset.addValue(5.0, series1, category5);
        ...
        while(rs.next()){
            dataset.setValue(rs.getDouble("NumOfCitizens"), rs.getString("AreaCode"), "abc");
        }
